...
for BUILD_DIR in \
    "$SCRIPT_DIR/temp/python_build/_bld/openssl-1.1.1u-universal/x86_64" \
    "$SCRIPT_DIR/temp/python_build/_bld/openssl-1.1.1u" \
    "$SCRIPT_DIR/temp/python_build/_bld/openssl-1.1.1t-universal/x86_64" \
    "$SCRIPT_DIR/temp/python_build/_bld/openssl-1.1.1t" \
    "$SCRIPT_DIR/temp/python_build/_bld/openssl-universal/x86_64" \
